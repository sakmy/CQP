window.onload = function() {
  ...
  var op3  = {
    ...
    xAxis: [
        {
            type: 'category',
            data: ['（空白）', '重庆市', '湖北省', '四川省', '广东省', '河南省', '江苏省', '上海市', '江西省  ', '山东省  ', '浙江省  ', '北京市  ', '陕西省  '
      , '贵州省  ', '河北省  ', '安徽省  ', '湖南省  ', '吉林省  ', '福建省  ', '甘肃省  '],
      axisLabel: {
         interval:0,
         rotate:40,
         margin:20,
  ...
  series: [{
    type: 'bar',
    data: [23, 21,21,32,34,34,45,67,34,23, 21,21,32,34,34,45,67,34,67,34],
    label: {
      show: true,
      position: 'top',
    },
  ...
  var op6 = {
    ...
    series: [{
      name: '2011年',
      type: 'bar',
      data: [18203, 23489, 29034, 104970, 131744,18203, 23489, 29034, 104970, 131744,18203, 23489, 29034, 104970, 131744, 131744, 131744, 131744],
      label: {
        show: true,
        position: 'right',
      },
